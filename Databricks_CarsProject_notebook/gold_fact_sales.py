...
df_silver=spark.sql("Select * From PARQUET.`abfss://silver@azuredwhengglake.dfs.core.windows.net/Carsales`")
...
df_fact=df_silver.join(df_branch,df_silver['Branch_ID']==df_branch['Branch_ID'],how='left')\
        ...
        .join(df_date,df_silver['Date_ID']==df_date['Date_ID'],how='left')\
         ...
         .select(df_silver['Revenue'],df_silver['Units_Sold'],df_silver['RevPerUnit'],df_branch['dim_branch_key'],df_model['dim_model_key'],df_date['dim_date_key'],df_dealer['dim_dealer_key'])   
...
if spark.catalog.tableExists('factsales'):
    ...
    df_fact.write.format('delta')\
        .mode('Overwrite')\
        .option("path","abfss://gold@azuredwhengglake.dfs.core.windows.net/factsales")\
